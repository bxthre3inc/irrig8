...
\usepackage{graphicx,float,textcomp}
\usepackage{tcolorbox}
\tcbuselibrary{theorems}
\usepackage{xcolor}
\usepackage{listings}
\lstset{basicstyle=\ttfamily, columns=fullflexible, breaklines=true}
\lstdefinestyle{bx3}{backgroundcolor=\color{gray!10},basicstyle=\ttfamily\small,frame=single,breaklines=true,numbers=left,numberstyle=\tiny\color{gray!60},belowskip=0pt}
\usepackage{fancyhdr}

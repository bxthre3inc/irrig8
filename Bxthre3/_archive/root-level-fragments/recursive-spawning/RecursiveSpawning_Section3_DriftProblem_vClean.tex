...
\end{equation}
A drifted agent may be orphaned (its parent is gone) or may have a living parent whose own chain does not reach any human principal. Drift is a property of the chain's origin, not of the chain's intermediate connectivity.

...
\begin{enumerate}
    ...
    \item[(V3)] \textbf{Verify Purpose Layer warrants.} For each link $\alpha(n_{j+1}) = n_j$ in the chain, confirm the spawn event was recorded in the forensic ledger with a matching Purpose Layer warrant from Equation~\ref{eq:rs-warrant}.

...
\begin{equation}
\bigl( \alpha(n) = \bot \ \lor\ \mathrm{unreachable}(\alpha(n)) \bigr)\ \;\land\;
\bigl( \neg\exists\, h \in \mathcal{H} : \mathrm{chain-reaches}(n, h) \bigr)\ ;\land\;
